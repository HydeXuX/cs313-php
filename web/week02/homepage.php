...
<head>
    <title>Hyde Xu's Homepage</title>
</head>

<body>
    <h1>Welcome to Hyde Xu's homepage</h1>
    <h2>Introudction</h2>
    <div>
        <p>Welcome to my homepage. My name is Hyde Xu. I'm from Shanghai, China. It's one of the biggest cities in the world.</p>
        <h3>Something about me</h3>
        <p>I'm trilingual and I speak Mandarin Chinese, English and Japnese. I love learn languages since you can also discover a lot about their culture. I enjoy sketching and listening to music a lot. I also have passion in gaming.</p>
        <h4>Here is a picture of one of my work I did in an art class</h4>
